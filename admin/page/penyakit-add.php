                        ...
                        <div class="card-body">
                            <form action="#" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" name=" kode_penyakit" id="" class="form-control" placeholder="Masukan Kode Penyakit">
                                </div>
                                <div class="form-group">
                                    <label for="" class="form-label">Nama Penyakit</label>
                                    <input type="text" name="nama_penyakit" id="" class="form-control" placeholder="Masukan Nama Penyakit">
                                </div>
                                <div class="form-group">
